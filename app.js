...
const READING_MODES = {
  0: {
    ...
    intro: 'Draw as many cards as you like. Each card appears in the chat, then send whenever you\'re ready — with or without a message — to read everything on the table.',
    positions: [],
    systemPrompt: composeSystemPrompt([
      ...
      '(a) The querent draws cards freely and submits when ready — with a question, a partial thought, or nothing at all. Read all accumulated cards as a unified field. There are no predefined positions; interpret them as an evolving constellation of symbols rather than a formal spread.',
      '(b) On follow-up turns, the full card set is still the shared context. Respond directly to what the querent asks, referencing specific cards only when they are load-bearing for the answer.',
